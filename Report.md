...
To illustrate our predictive result, we list the below table which is the forecast given by our model for the numbers of active firms in finance and insurance area in each province for the next 8 quarters:  
